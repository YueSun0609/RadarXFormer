...
from rxf.datasets import prepare
from rxf.datasets.kradar.utils import radar_info
from rxf.utils import visu
from rxf.utils.config import load_config
from rxf.utils.geometry import get_transformation, transform_boxes, transform_points
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser('RXF data preprocessing')
